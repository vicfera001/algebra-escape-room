    ...
    <div className="absolute inset-0 z-50 bg-background flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      >
        <div className="bg-card p-10 rounded-2xl border border-border shadow-2xl text-center w-full relative overflow-hidden">
          ...
          <h1 className="text-5xl font-extrabold text-primary mb-2 tracking-tight">Algebra Escape Room</h1>
          <p className="text-xl text-muted-foreground mb-10">Solve the puzzles. Find the code. Escape.</p>
          
          <div className="bg-muted/50 rounded-xl p-6 text-left mb-10 border border-border/50">
            <h2 className="text-lg font-bold text-foreground mb-4 uppercase tracking-wider">Instructions</h2>
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-center gap-3">
                <kbd className="px-2 py-1 bg-background rounded border border-border font-mono text-sm">W A S D</kbd>
                <span>Move around the classroom</span>
              </li>
              <li className="flex items-center gap-3">
                <kbd className="px-2 py-1 bg-background rounded border border-border font-mono text-sm">Mouse</kbd>
                <span>Look around (Click canvas to lock pointer)</span>
              </li>
              <li className="flex items-center gap-3">
                <kbd className="px-2 py-1 bg-background rounded border border-border font-mono text-sm">E</kbd>
                <span>Interact with highlighted objects</span>
              </li>
              <li className="flex items-center gap-3 mt-4 text-primary">
                <span className="font-bold">Goal:</span> Solve 3 algebra equations to find the 3-digit door code.
              </li>
            </ul>
          </div>
